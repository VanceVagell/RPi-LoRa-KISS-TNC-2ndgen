...
class LoRa(object):
    ...
    def __init__(self, verbose=True, do_calibration=True, calibration_freq=915.000):
        """ Init the object
...
#        print("Before TX self.spi.xfer, payload: " + str(payload))
#        idx = 0
#        for c in payload:
#            print("Data[" + repr(idx) + "]: " + repr(c))
#            idx = idx + 1
#        print("self: " + str(self))
    ...
    def read_payload(self , nocheck = False):
        ...
        # print("Before RX self.spi.xfer, self: " + str(self))
        return payload
    ...
    def rx_chain_calibration(self, freq=915.000):
